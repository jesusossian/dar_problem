# Event-based MILP for DARP

This is the C++ implementation of the event-based MILP for the static Dial-a-Ride Problem proposed in<br>

Gaul, Klamroth, Stiglmayr, 2021. Event-based MILP models for ridepooling applications.<br>
European Journal of Operational Research, Volume 301, Issue 3, 1048-1063. <br>
https://doi.org/10.1016/j.ejor.2021.11.053.<br>

For details of the event-based MILP and implementation please refer to the above reference. <br>
Any feedback is welcome, please send an email to gaul@math.uni-wuppertal.de.<br>
 ...
 - Test instance consists of one file:  <br>
    <pre>
    2 32 480 3 30
...
- Test instance consists of two files:<br>
...
This repository contains the benchmark test instances "a-b-set" for the DARP created by Cordeau, Laporte and Ropke in: <br>
 - Cordeau, 2006. A branch-and-cut algorithm for the dial-a-ride problem. Oper. Res. 54 (3), 573–586. 
 - Ropke, Cordeau, Laporte, 2007. Models and branch-and-cut algorithms for pickup and delivery problems with time windows. Networks 49, 258–272.<br>

The first line of the instances' data has been modified. The original version can be found at: http://neumann.hec.ca/chairedistributique/data/darp/branch-and-cut/.

 ## Running an instance

 Q=3-instances:<br>
 ./bin/darp_milp_3 instance_name e.g. ./bin/darp_milp_3 a2-16<br>
 
 Q=6-instances:<br>
 ./bin/darp_milp_6 instance_name e.g. ./bin/darp_milp_6 b2-16<br>
...
https://git.uni-wuppertal.de/dgaul/event-based-milp-for-darp
